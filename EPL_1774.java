...
/*
$HeadURL: https://svn.ingenico.com/SPO/Dev/ePortal/branches/20140616_eportal_3.3.1/src/com/ingenico/eportal/testsuite/cardPayment/EPL_1774.java $
$Id: EPL_1774.java 7916 2014-06-10 12:30:12Z cariram $
 */
...
public class EPL_1774 extends SuiteCardPayment
{
	/**
	 * EPL-1774 Check content of view receipt
	 * @throws IOException
	 */
	@Test()
	public void epl_1774()
	{		
		try
		{
			logger.info(" EPL-1774 executing started");	
			login(CONFIG.getProperty("l2_superuser"),CONFIG.getProperty("superuserPassword"));	
			logger.info("Step 1:");
			...
			logger.info(" EPL-1774 execution successful");
		} 
		catch (Throwable t)
		{
