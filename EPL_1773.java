...
/*
$HeadURL: https://svn.ingenico.com/SPO/Dev/ePortal/branches/20140616_eportal_3.3.1/src/com/ingenico/eportal/testsuite/cardPayment/EPL_1773.java $
$Id: EPL_1773.java 7916 2014-06-10 12:30:12Z cariram $
 */
...
public class EPL_1773 extends SuiteCardPayment
{
	/**
	 * EPL-1773 Check content of view receipt
	 * @throws IOException
	 */
	@Test()
	public void epl_1773()
	{		
		try
		{
			logger.info(" EPL-1773 executing started");	
			login(CONFIG.getProperty("l1_superuser"),CONFIG.getProperty("superuserPassword"));
			logger.info("Step 1:");
			//Choose a customer (for example QA_EPORTAL_C1) 			
			selectItem(getObject("client_xpath"), custOne);
			...
			logger.info(" EPL-1773 execution successful");
		} 
		catch (Throwable t)
		{
